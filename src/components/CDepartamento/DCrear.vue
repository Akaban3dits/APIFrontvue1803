  ...
  <div class="signupFrm">
    <form action="" class="form" v-on:submit.prevent="formulario">
      ...
      <div class="inputContainer">
        <input type="text" class="input" placeholder="a" v-model="Departamento.nombre" id="name">
        <label for="" class="label">Nombre del Departamento</label>
      </div>
...
export default {
  ...
  methods: {
    formulario() {
      ...
      axios.post("https://localhost:7294/Departamento", datosEnviar).then((result) => {
